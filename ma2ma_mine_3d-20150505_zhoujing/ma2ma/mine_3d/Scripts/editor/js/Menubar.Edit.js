Menubar.Edit = function ( editor ) {
	...
	var menuConfig = [
		...
		createOption( '合并', onCloneOptionClick ),
		createOption( '分割', onDeleteOptionClick ),
		createDivider(),

		createOption( '交集', onConvertOptionClick ),
		createOption( '并集', onFlattenOptionClick )
	];

	var optionsPanel = UI.MenubarHelper.createOptionsPanel( menuConfig );

	return UI.MenubarHelper.createMenuContainer( '编辑', optionsPanel );
}
