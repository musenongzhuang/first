...
//	}
	...
	var menuConfig = [
//		createOption( '刷新', onNewOptionClick ),
//		createDivider(),
//
//		createOption( '导入', onImportOptionClick ),
//		createDivider(),

		createOption( '导出框架', onExportGeometryOptionClick ),
		createOption( '导出物体', onExportObjectOptionClick ),
		createOption( '导出场景', onExportSceneOptionClick ),
        createDivider(),
		createOption( '导出obj', onExportOBJOptionClick ),
		createOption( '导出stl', onExportSTLOptionClick )
	];

	var optionsPanel = UI.MenubarHelper.createOptionsPanel( menuConfig );

	return UI.MenubarHelper.createMenuContainer( '导出', optionsPanel );
